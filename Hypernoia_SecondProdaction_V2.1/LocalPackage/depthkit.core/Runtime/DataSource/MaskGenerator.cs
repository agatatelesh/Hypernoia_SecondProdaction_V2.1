...
namespace Depthkit
{
    ...
    public class MaskGenerator : IPropertyTransfer
    {
        ...
        protected ComputeBuffer m_sobelMultiplierBuffer;
        ...
        public void Release()
        {
            if (m_sobelMultiplierBuffer != null) m_sobelMultiplierBuffer.Dispose();
        ...
        public void SobelFilterMask()
        {
            ...
            if (m_sobelMultiplierBuffer == null || m_sobelMultiplierBuffer.count != sliceCount)
            {
                if (m_sobelMultiplierBuffer != null) m_sobelMultiplierBuffer.Dispose();
                m_sobelMultiplierBuffer = new ComputeBuffer(sliceCount, sizeof(float));
            }
