...
namespace Depthkit
{
    ...
    public class Metadata
    {
        ...
        public class DefaultReconstructionSettings
        {
            ...
            public float depthBiasAdjustment = 0.008f;
            public float edgeMaskBlurAmount = 0.01f;
            public float edgeMaskSobelMultiplier = 50.0f;
            public float surfaceNormalColorBlendPower = 1.0f;
            public float viewDependentColorBlendPower = 1.0f;
        }
